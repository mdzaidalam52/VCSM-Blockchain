    ...
    return (
        <>
            <BrowserRouter>
                <Navbar bg='primary' variant='dark'>
                    <Container>
                        ...
                        <Nav className='me-auto'>
                            <Nav.Link>
                                <Link to='/beneficiary' className='link'>Beneficiary</Link>
                            </Nav.Link>
                            <Nav.Link>
                                <Link to='/admin' className='link'>Admin</Link>
                            </Nav.Link>
                            <Nav.Link>
                                <Link to='/manufacturer' className='link'>Manufacturer</Link>
                            </Nav.Link>
                            <Nav.Link>
                ...
                <Container>
                    <Routes>
                        <Route path='beneficiary' element={<Beneficiary/>} exact/>
                    </Routes>
                </Container>
            </BrowserRouter>
        </>
